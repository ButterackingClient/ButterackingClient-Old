...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        Client.I.init();
        Client.I.getDiscordrp().update("IceMoon Client", "");
        this.gameSettings = new GameSettings(this, this.mcDataDir);
        this.defaultResourcePacks.add(this.mcDefaultResourcePack);
        this.startTimerHackThread();
        if (this.gameSettings.overrideHeight > 0 && this.gameSettings.overrideWidth > 0) {
        ...
        this.renderEngine.bindTexture(TextureMap.locationBlocksTexture);
        this.textureMapBlocks.setBlurMipmapDirect(false, this.gameSettings.mipmapLevels > 0);
        SplashProgress.setProgress(2, "Client - ModelManager");
        this.modelManager = new ModelManager(this.textureMapBlocks);
        this.mcResourceManager.registerReloadListener(this.modelManager);
        SplashProgress.setProgress(3, "Client - RenderItem");
        this.renderItem = new RenderItem(this.renderEngine, this.modelManager);
        SplashProgress.setProgress(4, "Client - RenderManager");
        this.renderManager = new RenderManager(this.renderEngine, this.renderItem);
        this.itemRenderer = new ItemRenderer(this);
        this.mcResourceManager.registerReloadListener(this.renderItem);
        SplashProgress.setProgress(5, "Client - EntityRenderer");
        this.entityRenderer = new EntityRenderer(this, this.mcResourceManager);
        this.mcResourceManager.registerReloadListener(this.entityRenderer);
        SplashProgress.setProgress(6, "Client - BlockRenderer");
        this.blockRenderDispatcher = new BlockRendererDispatcher(this.modelManager.getBlockModelShapes(), this.gameSettings);
        this.mcResourceManager.registerReloadListener(this.blockRenderDispatcher);
        SplashProgress.setProgress(7, "Client - RenderGlobal");
        this.renderGlobal = new RenderGlobal(this);
        this.mcResourceManager.registerReloadListener(this.renderGlobal);
        this.guiAchievement = new GuiAchievement(this);
        GlStateManager.viewport(0, 0, this.displayWidth, this.displayHeight);
    ...
    private void initStream() {
        try {
            this.stream = new TwitchStream(this, (Property) Iterables.getFirst((Iterable) this.twitchDetails.get((String) "twitch_access_token"), (Object) null));
        } catch (Throwable throwable) {
            this.stream = new NullStream(throwable);
    ...
    private void checkGLError(final String message) {
        if (this.enableGLErrorChecking) {
            ...
            if (i != 0) {
                ...
                Minecraft.logger.error(String.valueOf(String.valueOf(String.valueOf(i))) + ": " + s);
            }
        }
    }
    ...
    private void updateDebugProfilerName(int keyCount) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (keyCount == 0) {
                ...
                if (this.debugProfilerName.length() > 0) {
                    this.debugProfilerName = String.valueOf(String.valueOf(String.valueOf(this.debugProfilerName))) + ".";
                }
                this.debugProfilerName = String.valueOf(String.valueOf(String.valueOf(this.debugProfilerName))) + list.get(keyCount).field_76331_c;
            }
        }
    }
    ...
    private void displayDebugInfo(final long elapsedTicksTime) {
        if (this.mcProfiler.profilingEnabled) {
            ...
            String s = "";
            if (!profiler$result.field_76331_c.equals("unspecified")) {
                s = String.valueOf(String.valueOf(String.valueOf(s))) + "[0] ";
            }
            if (profiler$result.field_76331_c.length() == 0) {
                s = String.valueOf(String.valueOf(String.valueOf(s))) + "ROOT ";
            } else {
                s = String.valueOf(String.valueOf(String.valueOf(s))) + profiler$result.field_76331_c + " ";
            }
            final int l3 = 16777215;
            this.fontRendererObj.drawStringWithShadow(s, (float) (j - 160), (float) (k - 80 - 16), 16777215);
            this.fontRendererObj.drawStringWithShadow(s = String.valueOf(String.valueOf(String.valueOf(decimalformat.format(profiler$result.field_76330_b)))) + "%", (float) (j + 160 - this.fontRendererObj.getStringWidth(s)), (float) (k - 80 - 16), 16777215);
            for (int k3 = 0; k3 < list.size(); ++k3) {
                ...
                if (profiler$result3.field_76331_c.equals("unspecified")) {
                    s2 = String.valueOf(String.valueOf(String.valueOf(s2))) + "[?] ";
                } else {
                    s2 = String.valueOf(String.valueOf(String.valueOf(s2))) + "[" + (k3 + 1) + "] ";
                }
                s2 = String.valueOf(String.valueOf(String.valueOf(s2))) + profiler$result3.field_76331_c;
                this.fontRendererObj.drawStringWithShadow(s2, (float) (j - 160), (float) (k + 80 + k3 * 8 + 20), profiler$result3.getColor());
                this.fontRendererObj.drawStringWithShadow(s2 = String.valueOf(String.valueOf(String.valueOf(decimalformat.format(profiler$result3.field_76332_a)))) + "%", (float) (j + 160 - 50 - this.fontRendererObj.getStringWidth(s2)), (float) (k + 80 + k3 * 8 + 20), profiler$result3.getColor());
                this.fontRendererObj.drawStringWithShadow(s2 = String.valueOf(String.valueOf(String.valueOf(decimalformat.format(profiler$result3.field_76330_b)))) + "%", (float) (j + 160 - this.fontRendererObj.getStringWidth(s2)), (float) (k + 80 + k3 * 8 + 20), profiler$result3.getColor());
            }
        }
    }
    ...
    private void sendClickBlockToController(final boolean leftClick) {
        ...
        if (!Client.I.hudManager.oa.isEnabled()) {
            if (this.leftClickCounter <= 0 && !this.thePlayer.isUsingItem()) {
                if (leftClick && this.objectMouseOver != null && this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
        ...
        else if (Client.I.hudManager.oa.isEnabled()) {
            if (this.leftClickCounter <= 0 && !this.thePlayer.isUsingItem()) {
                if (leftClick && this.objectMouseOver != null && this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                    final BlockPos blockpos = this.objectMouseOver.getBlockPos();
                    if (this.theWorld.getBlockState(blockpos).getBlock().getMaterial() != Material.air && this.playerController.onPlayerDamageBlock(blockpos, this.objectMouseOver.sideHit)) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        if (this.gameSettings.keyBindSmoothCamera.isPressed()) {
                            final GameSettings gameSettings3;
                            final GameSettings gameSettings4;
                            final GameSettings gameSettings2 = gameSettings4 = (gameSettings3 = this.gameSettings);
                            ++gameSettings4.showDebugInfo;
                            if (this.gameSettings.showDebugInfo > 2) {
                                this.gameSettings.showDebugInfo = 0;
                            }
                            if (this.gameSettings.showDebugInfo == 0) {
                    ...
                    if (!this.gameSettings.showLagometer) {
                        continue;
                    }
                    if (k == 11) {
                        this.updateDebugProfilerName(0);
...
//        RenderDistanceModifier.checkFPS();
        final ClientTick event = new ClientTick();
        event.call();
        this.mcProfiler.endSection();
        this.systemTime = getSystemTime();
    }
    ...
    public void launchIntegratedServer(final String folderName, final String worldName, WorldSettings worldSettingsIn) {
        ...
        networkmanager.sendPacket(new C00PacketLoginStart(this.getSession().getProfile()));
        this.myNetworkManager = networkmanager;
        Client.I.getDiscordrp().update("SinglePlayer", "In Game");
    }
    ...
    public static boolean isGuiEnabled() {
        return Minecraft.theMinecraft == null || !Minecraft.theMinecraft.gameSettings.thirdPersonView;
    }
    ...
    public CrashReport addGraphicsAndWorldToCrashReport(final CrashReport theCrash) {
        ...
        theCrash.getCategory().addCrashSectionCallable("OpenGL", new Callable<String>() {
            @Override
            public String call() {
                return String.valueOf(String.valueOf(String.valueOf(GL11.glGetString(7937)))) + " GL version " + GL11.glGetString(7938) + ", " + GL11.glGetString(7936);
            }
        });
        theCrash.getCategory().addCrashSectionCallable("GL Caps", new Callable<String>() {
            @Override
    ...
    public <V> ListenableFuture<V> addScheduledTask(final Callable<V> callableToSchedule) {
        ...
        if (!this.isCallingFromMinecraftThread()) {
            ...
            synchronized (this.scheduledTasks) {
                ...
                final ListenableFutureTask<V> listenableFutureTask3;
                final ListenableFutureTask<V> listenableFutureTask4;
                final ListenableFutureTask<V> listenableFutureTask2 = listenableFutureTask4 = (listenableFutureTask3 = listenablefuturetask);
                // monitorexit(this.scheduledTasks)
                return (ListenableFuture<V>) listenableFutureTask4;
            }
        }
        try {
