...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    protected boolean setBrightness(final T entitylivingbaseIn, final float partialTicks, final boolean combineTextures) {
        ...
        this.brightnessBuffer.position(0);
        if (flag2) {
            if (!Client.I.hudManager.h.isEnabled()) {
                this.brightnessBuffer.put(1.0f);
                this.brightnessBuffer.put(0.0f);
                this.brightnessBuffer.put(0.0f);
                this.brightnessBuffer.put(0.3f);
            ...
            if (Client.I.hudManager.h.isEnabled()) {
                this.brightnessBuffer.put(Client.I.pr);
                this.brightnessBuffer.put(Client.I.pg);
                this.brightnessBuffer.put(Client.I.pb);
                this.brightnessBuffer.put(0.4f);
                if (Config.isShaders()) {
                    Shaders.setEntityColor(Client.I.pr / 255.0f + 0.0f, Client.I.pg / 255.0f + 0.0f, Client.I.pb / 255.0f + 0.0f, 0.4f);
                }
            }
        } else {
