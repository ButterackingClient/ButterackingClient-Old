...
public class GuiScreenBook extends GuiScreen implements IInputTarget, IInputTarget.InputIdentifier {
    private static final Logger a2 = LogManager.getLogger();
    private static final ResourceLocation f2 = new ResourceLocation("textures/gui/book.png");
    ...
    private int field_175387_B = -1;
    private GuiScreenBook.acls buttonNextPage;
    private GuiScreenBook.acls buttonPreviousPage;
    private GuiButton buttonDone;
    ...
    public void initGui() {
        ...
        int i = (this.width - this.bookImageWidth) / 2;
        byte b0 = 2;
        this.buttonList.add(this.buttonNextPage = new GuiScreenBook.acls(1, i + 120, b0 + 154, true));
        this.buttonList.add(this.buttonPreviousPage = new GuiScreenBook.acls(2, i + 38, b0 + 154, false));
        this.updateButtons();
        this.ime.setCursor(this.pageGetCurrent().length());
     ...
     */
    private void keyTypedInTitle(char p_146460_1_, int p_146460_2_) throws IOException {
        if ((p_146460_2_ == 28 || p_146460_2_ == 156) && !this.bookTitle.isEmpty()) {
            this.sendBookToServer(true);
            this.mc.displayGuiScreen((GuiScreen) null);
        }
    ...
    private void pageInsertIntoCurrent(String p_146459_1_) {
        String s = this.pageGetCurrent();
        String s1 = s + p_146459_1_;
        int i = this.fontRendererObj.splitStringWidth(s1 + GuiScreenBook.acls.buttonTextures + "_", 118);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        this.mc.getTextureManager().bindTexture(f2);
        int i = (this.width - this.bookImageWidth) / 2;
        byte b0 = 2;
        this.drawTexturedModalRect(i, b0, 0, 0, this.bookImageWidth, this.bookImageHeight);
        ...
        if (this.bookGettingSigned) {
            ...
            this.fontRendererObj.drawString(s1, i + 36 + (116 - j) / 2, b0 + 16 + 16, 0);
            int k = this.fontRendererObj.getStringWidth(s);
            this.fontRendererObj.drawString(s, i + 36 + (116 - k) / 2, b0 + 48, 0);
            String s2 = I18n.format("book.byAuthor", new Object[]{this.editingPlayer.getName()});
            int l = this.fontRendererObj.getStringWidth(s2);
            this.fontRendererObj.drawString(EnumChatFormatting.DARK_GRAY + s2, i + 36 + (116 - l) / 2, b0 + 48 + 10, 0);
            String s3 = I18n.format("book.finalizeWarning", new Object[0]);
            this.fontRendererObj.drawSplitString(s3, i + 36, b0 + 80, 116, 0);
        } else {
            String s4 = I18n.format("book.pageIndicator", new Object[]{Integer.valueOf(this.currPage + 1), Integer.valueOf(this.bookTotalPages)});
            String s5 = "";
            ...
            int i1 = this.fontRendererObj.getStringWidth(s4);
            this.fontRendererObj.drawString(s4, i - i1 + this.bookImageWidth - 44, b0 + 16, 0);

            if (this.field_175386_A == null) {
                this.fontRendererObj.drawSplitString(s5, i + 36, b0 + 16 + 16, 116, 0);
            } else {
                int j1 = Math.min(128 / this.fontRendererObj.FONT_HEIGHT, this.field_175386_A.size());

                for (int k1 = 0; k1 < j1; ++k1) {
                    IChatComponent ichatcomponent2 = (IChatComponent) this.field_175386_A.get(k1);
                    this.fontRendererObj.drawString(ichatcomponent2.getUnformattedText(), i + 36, b0 + 16 + 16 + k1 * this.fontRendererObj.FONT_HEIGHT, 0);
                }
    ...
    public String getTargetText() {
        return this.bookIsUnsigned ? (this.bookGettingSigned ? this.bookTitle : this.pageGetCurrent()) : "";
    }

    public boolean setTargetText(String p_setTargetText_1_) {
        if (this.bookIsUnsigned) {
            if (this.bookGettingSigned) {
                this.bookTitle = p_setTargetText_1_;
            } else {
                this.pageSetCurrent(p_setTargetText_1_);
            }
    ...
    public boolean apply(String p_apply_1_) {
        if (this.bookIsUnsigned) {
            ...
            String s = this.pageGetCurrent() + p_apply_1_;
    ...
    static class acls extends GuiButton {
        private final boolean o;

        public acls(int p_i0_1_, int p_i0_2_, int p_i0_3_, boolean p_i0_4_) {
            super(p_i0_1_, p_i0_2_, p_i0_3_, 23, 13, "");
            this.o = p_i0_4_;
        }
        ...
        public void drawButton(Minecraft mc, int mouseX, int mouseY) {
            if (this.visible) {
                boolean flag = mouseX >= this.xPosition && mouseY >= this.yPosition && mouseX < this.xPosition + this.width && mouseY < this.yPosition + this.height;
                GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
                mc.getTextureManager().bindTexture(GuiScreenBook.f2);
                int i = 0;
                int j = 192;
