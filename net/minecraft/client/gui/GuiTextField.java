...
public class GuiTextField extends Gui implements IInputTarget, IInputTarget.WriteTextFunc, IInputTarget.CursorSelectionFunc {
    private final int id;
    private final FontRenderer fontRendererInstance;
    public int xPosition;
    public int yPosition;
    ...
    public GuiTextField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height) {
        ...
        this.width = par5Width;
        this.height = par6Height;
        this.ime.setWriteTextFunc(this);
     ...
     */
    public boolean textboxKeyTyped(char p_146201_1_, int p_146201_2_) {
        return !this.isFocused ? false : this.ime.onTyped(p_146201_2_, p_146201_1_);
    }
    ...
    public boolean setTargetText(String p_setTargetText_1_) {
        if (this.field_175209_y.apply(p_setTargetText_1_)) {
            if (p_setTargetText_1_.length() > this.maxStringLength) {
                this.text = p_setTargetText_1_.substring(0, this.maxStringLength);
            } else {
                this.text = p_setTargetText_1_;
            }
    ...
    public void setCursor(int p_setCursor_1_) {
        this.setCursorPosition(p_setCursor_1_);
    }
    ...
    public void setSelection(int p_setSelection_1_) {
        this.setSelectionPos(p_setSelection_1_);
    }

    public void writeTextFunc(String p_writeTextFunc_1_) {
        this.writeText(p_writeTextFunc_1_);
    }
}
