...
public class GuiMainMenu extends GuiScreen {
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        this.mc.getTextureManager().bindTexture(new ResourceLocation("client/mainmenu.png"));
    ...
    @Override
    public void initGui() {
        InputMethod.setInterface(new VanillaInterface());
        SimpleButton.setRenderInterface(new VanillaSimpleButtonRenderer());
        DeltaTimer.D.stop();
        Client.I.getDiscordrp().update("", "Idle");

        this.buttonList.add(new GuiButton(1, this.width / 2 - 100 , this.height / 3 + 10, "SinglePlayer"));
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100 , this.height / 3 + 34, "MultiPlayer"));
        this.buttonList.add(new GuiButton(3, this.width / 2 - 100 , this.height / 3 + 58, "Options"));
        this.buttonList.add(new GuiButton(5, this.width / 2 + 2 , this.height / 3 + 82,99,20, "Quit"));
        this.buttonList.add(new GuiButton(4, this.width / 2 - 100 , this.height / 3 + 82,99,20, "Resourcepacks"));
        this.buttonList.add(new GuiButton(6, 10000000, this.height / 3 + 99999999, "x"));
        /*
        this.buttonList.add(new GuiButton(1, 10 , this.height / 3 - 10, "SinglePlayer"));
        this.buttonList.add(new GuiButton(2, 10 , this.height / 3 + 14, "MultiPlayer"));
        this.buttonList.add(new GuiButton(3, 10 , this.height / 3 + 38, "Options"));
        this.buttonList.add(new GuiButton(5, 10 , this.height / 3 + 86, "Quit"));
        this.buttonList.add(new GuiButton(4, 10 , this.height / 3 + 62, "Resourcepacks"));
        this.buttonList.add(new GuiButton(6, 10000000, this.height / 3 + 99999999, "x"));
        */
    }
