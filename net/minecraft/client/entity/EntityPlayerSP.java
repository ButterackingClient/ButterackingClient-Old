...
//        RenderDistanceModifier.checkFPS();
    ...
    public void onLivingUpdate() {
        ...
        if (!this.isSprinting() && this.movementInput.moveForward >= f && flag4 && !this.isUsingItem() && !this.isPotionActive(Potion.blindness) && this.mc.gameSettings.keyBindInventory.isKeyDown()) {
            this.setSprinting(true);
        }
